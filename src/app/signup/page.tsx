...
function SignUpForm() {
  ...
  async function onSubmit(data: SignUpInput) {
    ...
    toast.success('Welcome to AisleIQ! Check your inbox to verify your email.')
        ...
        <div className="glass shadow-2xl rounded-2xl p-7 space-y-5">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div className="space-y-1.5">
              <Label htmlFor="name" className="text-slate-700 dark:text-slate-300 text-xs font-semibold uppercase tracking-wide">Full Name</Label>
              <Input
                id="name"
              ...
              />
              {errors.name && (
                <p className="text-xs text-destructive animate-slide-up">{errors.name.message}</p>
              )}
            </div>
